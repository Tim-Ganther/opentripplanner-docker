...
RUN set -x && \
    ...
    wget -O $OTP_GRAPHS/ngermany/fv-gtfs.zip https://download.gtfs.de/germany/fv_free/latest.zip && \
    wget -O $OTP_GRAPHS/ngermany/rv-gtfs.zip https://download.gtfs.de/germany/rv_free/latest.zip && \
    wget -O $OTP_GRAPHS/ngermany/nv-gtfs.zip https://download.gtfs.de/germany/nv_free/latest.zip && \
